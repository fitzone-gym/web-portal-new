  ...
  return (
    ...
    <div className="grid grid-flow-col auto-cols-2 bg-neutral-900 ml-5 mr-5 pt-6 pb-6 rounded-t-lg ">
        ...
        <form>
          <div className="relative">
            ...
            <input
             ...
             placeholder="Search Month, Reason"
             required
            />
            <button
              type="submit"
      ...
      <div className="">
        ...
        <a href='/Receptionist/Applyleave'>
        <button
              type="button"
